...
setup['Exp']['lim'] = 0                                                                                                  # 0) component limits are not used (using Vdc=1000V), 1) component limits enforced, 2) enforce only voltage

# ------------------------------------------
# Plotting
# ------------------------------------------
setup['Exp']['plot'] = 3                                                                                                 # 1) Plotting reduced, 2) Plotting detail, 3) Plotting lifetime
